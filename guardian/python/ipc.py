...
from flaskutils import abort, respond
...
class IpcUtils(object):
    ...
    @staticmethod
    async def send(port, msg, resp_obj, auth_token = None, verbose = False):
        """
        ...
        Args:
            ...
            resp_obj: The response object (output)
        ...
        # Send asynchronously
        json_response = await IpcUtils.send_json(port=port, data=data, verbose=verbose)
